...
python -m generate.generate_filtered model=generate dataset=allcts model.m=1 model.class_idx=3 model.name_prefix=allcts-051-216-gen-qs5 model.n_samples=10 #55 #model.train_latents=generate/latents/allcts_training_latents.npy
