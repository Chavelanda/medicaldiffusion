from dataset import MRNetDataset, MRNetDatasetMSSSIM, MRNetDatasetSS, BRATSDataset, ADNIDataset, DUKEDataset, LIDCDataset, DEFAULTDataset, SKULLBREAKDataset, SKULLBREAKDatasetTriplet, AllCTsDataset, AllCTsDatasetSS, AllCts_MSSSIM
...
DATASET_CLASSES = {
    ...
    'AllCTs': (AllCTsDataset, {'train': {'split': 'train-val', 'qs': None, 'resize_d': 1, 'resize_h': 1, 'resize_w': 1, 'conditioned': True, 'binarize': False, 'metadata_name': 'metadata.csv'}, 'val': {'split': 'test', 'qs': None, 'resize_d': 1, 'resize_h': 1, 'resize_w': 1, 'conditioned': True, 'binarize': False, 'metadata_name': 'metadata.csv'}}),
